...
def add_vehicle():
    if request.method == "POST":
        ...
        vehicle_id = cur.lastrowid if not is_pg() else None
        if is_pg():
            # fetch id for postgres
            cur.execute("SELECT currval(pg_get_serial_sequence('vehicles','id'))")
